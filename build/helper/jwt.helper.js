...
exports.veriToken = exports.genToken = void 0;
...
const genToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    return jsonwebtoken_1.default.sign(user, JWT_SECRET_KEY, { expiresIn: JWT_EXPIRY_DATE });
});
exports.genToken = genToken;
// check token
const veriToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
